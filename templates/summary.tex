...
__PLACEHOLDER__FINDINGS_SENTENCE
\bigbreak
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{3cm}|>{\centering\arraybackslash}p{1.8cm}|>{\centering\arraybackslash}p{2.2cm}|>{\centering\arraybackslash}p{2.9cm}|}
    \hline
    \textbf{Severity} & \textbf{Found} & \textbf{Resolved} & \textbf{Acknowledged} \\
    \hline
    Critical Risk & __PLACEHOLDER__ISSUE_CRITICAL_COUNT & __PLACEHOLDER__ISSUE_CRITICAL_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_CRITICAL_ACKNOWLEDGED_COUNT \\
    \hline
    High Risk & __PLACEHOLDER__ISSUE_HIGH_COUNT & __PLACEHOLDER__ISSUE_HIGH_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_HIGH_ACKNOWLEDGED_COUNT \\
    \hline
    Medium Risk & __PLACEHOLDER__ISSUE_MEDIUM_COUNT & __PLACEHOLDER__ISSUE_MEDIUM_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_MEDIUM_ACKNOWLEDGED_COUNT \\
    \hline
    Low Risk & __PLACEHOLDER__ISSUE_LOW_COUNT & __PLACEHOLDER__ISSUE_LOW_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_LOW_ACKNOWLEDGED_COUNT \\
    \hline
    Informational & __PLACEHOLDER__ISSUE_INFORMATIONAL_COUNT & __PLACEHOLDER__ISSUE_INFORMATIONAL_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_INFORMATIONAL_ACKNOWLEDGED_COUNT \\
    \hline
    Gas Optimizations & __PLACEHOLDER__ISSUE_GAS_OPTIMIZATION_COUNT & __PLACEHOLDER__ISSUE_GAS_OPTIMIZATION_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_GAS_OPTIMIZATION_ACKNOWLEDGED_COUNT \\
    \hline
    Total & __PLACEHOLDER__ISSUE_TOTAL_COUNT & __PLACEHOLDER__ISSUE_TOTAL_RESOLVED_COUNT & __PLACEHOLDER__ISSUE_TOTAL_ACKNOWLEDGED_COUNT \\
    \hline
  \end{tabular}
\end{table}
